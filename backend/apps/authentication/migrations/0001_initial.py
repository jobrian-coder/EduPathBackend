    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('novice', 'Novice'), ('contributor', 'Contributor'), ('expert', 'Expert')], default='novice', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kcse_grades', models.JSONField(blank=True, null=True)),
                ('cluster_points', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('bookmark_type', models.CharField(choices=[('course', 'Course'), ('university', 'University'), ('post', 'Post'), ('society', 'Society')], max_length=20)),
