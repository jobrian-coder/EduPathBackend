...
class PaymentTransaction(models.Model):
    ...
    plan_type = models.CharField(max_length=20, default='student')
...
class ClassroomOfferCode(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    code = models.CharField(max_length=50, unique=True)
    creator = models.ForeignKey(User, on_delete=models.CASCADE, related_name='created_offers')
    claimed_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='claimed_offers', null=True, blank=True)
    ...
    def __str__(self):
        return f"{self.code} - {'Claimed' if self.is_claimed else 'Available'}"
