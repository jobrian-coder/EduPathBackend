    ...
    <div className="relative">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 border border-teal-200 dark:border-teal-800 rounded-lg bg-white dark:bg-slate-900/40 text-slate-800 dark:text-slate-100 placeholder-teal-500 focus:ring-2 focus:ring-teal-500 focus:border-transparent"
        />
